defmodule BotArmyRpg.Skills.Example do
  @moduledoc """
  Example skill for RPG Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_rpg.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_rpg.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_rpg/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_rpg.command.example"
    ]
  end
